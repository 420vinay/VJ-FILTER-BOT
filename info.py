...
BOT_TOKEN = environ.get('BOT_TOKEN', "7802189496:AAE0Q3JM-PMXNmoA4b16xEJNx5FMg3WRsGI")


# This Pictures Is For Start Message Picture, You Can Add Multiple By Giving One Space Between Each.
PICS = (environ.get('PICS', 'https://graph.org/file/78d01972a9701b51a14b3-9fcef70048b90b24ce.jpg')).split()
...
auth_users = [int(user) if id_pattern.search(user) else user for user in environ.get('AUTH_USERS', 'Vinay_yadav_166').split()]  # For Multiple Id Use One Space Between Each.
AUTH_USERS = (auth_users + ADMINS) if auth_users else []

# This Channel Is For When User Start Your Bot Then Bot Send That User Name And Id In This Log Channel, Same For Group Also.
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002188072311'))

# This Is File Channel Where You Upload Your File Then Bot Automatically Save It In Database 
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002228354177').split()]  # For Multiple Id Use One Space Between Each.
...
auth_channel = environ.get('AUTH_CHANNEL', '-1002228354177') # give your force subscribe channel id here else leave it blank
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://youngerbro313:UNGOMVykosPBSCr5@cluster0.9yq24.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")   # IF Multiple Database Is False Then Fill Only This Database Url.
DATABASE_NAME = environ.get('DATABASE_NAME', "youngerbro313")
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'youngerbro313')
...
# Links
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/movieschannelgrou')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/telugumovies40')
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'Tillofficial1') # Support Chat Link Without https:// or @
OWNER_LNK = environ.get('OWNER_LNK', 'https://t.me/Vinay_yadav_166')
